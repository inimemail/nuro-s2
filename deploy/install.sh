...
SUB2API_EDGE_GLOBAL_WORKERS=$(edge_env_value_or_default "SUB2API_EDGE_GLOBAL_WORKERS" "512")
SUB2API_EDGE_PER_ACCOUNT_WORKERS=$(edge_env_value_or_default "SUB2API_EDGE_PER_ACCOUNT_WORKERS" "128")
...
SUB2API_EDGE_QUEUE_WAIT_BUDGET_MS=$(edge_env_value_or_default "SUB2API_EDGE_QUEUE_WAIT_BUDGET_MS" "150")
