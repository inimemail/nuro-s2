...
vi.mock("vue-i18n", async () => {
  ...
  const translations: Record<string, string> = {
    ...
    "admin.settings.gatewayForwarding.codexCLIOnlyPolicy": "Codex 门禁策略",
    "admin.settings.gatewayForwarding.codexCLIOnlyPolicyHint": "仅对开启 Codex-only 的账号生效。",
    "admin.settings.gatewayForwarding.codexCLIOnlyBlacklist": "全局黑名单 JSON",
    "admin.settings.gatewayForwarding.codexCLIOnlyBlacklistPlaceholder": "[]",
    "admin.settings.gatewayForwarding.codexCLIOnlyBlacklistHint": "黑名单说明",
    "admin.settings.gatewayForwarding.codexCLIOnlyWhitelist": "全局白名单 JSON",
    "admin.settings.gatewayForwarding.codexCLIOnlyWhitelistPlaceholder": "[]",
    "admin.settings.gatewayForwarding.codexCLIOnlyWhitelistHint": "白名单说明",
    "admin.settings.gatewayForwarding.codexCLIOnlyEngineFingerprintSignals": "引擎指纹信号 JSON",
    "admin.settings.gatewayForwarding.codexCLIOnlyEngineFingerprintSignalsPlaceholder": "[]",
    "admin.settings.gatewayForwarding.codexCLIOnlyEngineFingerprintSignalsHint": "指纹说明",
