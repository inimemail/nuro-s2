...
export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      promptCacheCreationOptimizationInput125: '转为 1.25 倍输入',
      promptCacheCreationOptimizationInput125Hint: '方案 D：请求侧沿用方案 B；本节点保留真实缓存创建，对下游将创建量归零并折算为 1.25 倍普通输入。缓存读取保持真实值，仅当前账号生效。',
