export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      promptCacheBoostDisabledHint: '该 OpenAI 文本池账号未启用缓存增强。',
      promptCacheBoostNotApplicable: '不适用',
      promptCacheBoostNotApplicableHint: '仅 OpenAI 池模式且未开启图片池时可用。',
      ...
      upstreamStrongIsolationNotApplicableHint: '仅 OpenAI 池模式且未开启图片池时可用。',
