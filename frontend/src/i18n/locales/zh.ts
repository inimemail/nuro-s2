  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexCLIOnlyBlacklistPlaceholder: '示例：ua_contains = BadBot/',
        codexCLIOnlyBlacklistHint: '黑名单按 OR 语义匹配：originator 或任一 UA 标记命中即可在官方客户端检测前拦截。',
        codexCLIOnlyWhitelist: '全局白名单 JSON',
        codexCLIOnlyWhitelistPlaceholder: '示例：originator = Trusted Tool, ua_contains = Trusted Tool/',
        ...
        codexCLIOnlyEngineFingerprintSignalsPlaceholder: '示例：type = header_prefix, match = x-codex-, required = true',
