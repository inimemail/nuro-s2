  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamBilling: {
        ...
        adaptiveSchedulingFactor: '调度倍率折算',
        adaptiveSchedulingFactorHint: '仅用于健康优先和健康成本均衡的调度成本比较；不影响计费、倍率保护或自动同步。',
        adaptiveSchedulingObserved: '上游探测：{rate}',
        adaptiveSchedulingEffective: '调度倍率：{rate}',
        adaptiveSchedulingFactorInvalid: '调度倍率折算系数必须在 0.001 到 100 之间。',
