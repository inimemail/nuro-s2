    ...
    accounts: {
      ...
      openai: {
        ...
        firstTokenTimeoutStages: {
          title: '阶段性补帧策略',
          description: '根据最近一次真实首 Token 自动匹配阶段；超过最后一个保护上限时暂停补帧，延迟恢复后自动回到较低阶段。最多 10 个阶段。',
          automatic: '自动切换',
          add: '添加阶段',
          stage: '阶段 {stage}',
          placeholder: '补帧阈值',
          guard: '保护上限',
          remove: '删除阶段',
          placeholderRange: '补帧阈值必须在 1-3000 ms。',
          guardRange: '保护上限必须在 1-30000 ms。',
          ...
          stagePlaceholderInvalid: '阶段 {stage} 的补帧阈值必须在 1-3000 ms。',
          stageGuardInvalid: '阶段 {stage} 的保护上限必须在 1-30000 ms。',
