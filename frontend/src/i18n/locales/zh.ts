  ...
  admin: {
    ...
    settings: {
      ...
      gatewayConcurrency: {
        ...
        globalWorkersHint: '1-999999999；每个 Edge 副本同时处理的 relay 请求数，保存后需重启 Edge。',
        extra: '用户额外等待数',
      ...
      gatewayEdgeProtection: {
        ...
        headerBudget: '响应头总预算',
        headerBudgetHint: '单位 ms；必须大于 0，同一请求所有响应头尝试共享的总预算。',
        bodyIdleTimeout: 'body 空闲超时',
        bodyIdleTimeoutHint: '单位 ms；必须大于 0，只限制连续无数据，不限制正常长流总时长。',
        maxAttempts: '响应头最大尝试',
        maxAttemptsHint: '响应头超时时，此请求允许的上游总尝试次数（包含首次尝试）。',
        failover: '响应头超时切号',
