  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamBilling: {
        ...
        guard: '倍率保护',
        guardHint: '探测倍率超过阈值时停止新调度；恢复后自动解除。',
        groupGuardHint: '总开关开启后，自动应用当前绑定分组中已配置的保护上限；分组未配置则不限制。',
        advancedOverrides: '高级：账号-分组自定义保护倍率',
        inheritDefault: '分组默认上限：{rate}',
        inheritPlaceholder: '继承分组默认值',
        overrideLabel: '{group} 自定义保护倍率',
        overrideHint: '留空表示继承分组默认值，自定义值不能高于分组默认上限。',
        ...
        guardAvailable: '未超过保护上限，当前分组可调度',
