  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptBlocks: 'Claude OAuth System Blocks JSON',
        claudeOAuthSystemPromptBlocksPlaceholder: '[{"enabled":true,"type":"text","text":"{billing_header}"},{"enabled":true,"type":"text","text":"{claude_code_system_prompt}"},{"enabled":true,"type":"text","text":"{claude_code_expansion_prompt}","cache_control":{"type":"ephemeral","ttl":"5m"}}]',
        claudeOAuthSystemPromptBlocksHint: 'Leave empty to use the built-in three-block default. Supports {billing_header}, {cc_version}, {fp}, {claude_code_system_prompt}, and {claude_code_expansion_prompt}.',
