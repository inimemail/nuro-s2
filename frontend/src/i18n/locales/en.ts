  ...
  admin: {
    ...
    settings: {
      ...
      gatewayConcurrency: {
        ...
        globalWorkersHint: '1-999999999; relay requests handled concurrently by each Edge replica. Restart Edge after saving.',
      ...
      gatewayEdgeProtection: {
        ...
        headerBudgetHint: 'Milliseconds; must be greater than 0 and is shared by all header attempts for one request.',
        ...
        maxAttemptsHint: 'Maximum total upstream attempts for this request when response-header timeouts occur.',
