export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      promptCacheBoostDisabledHint: 'Cache boost is disabled for this OpenAI text-pool account.',
      promptCacheBoostNotApplicable: 'N/A',
      promptCacheBoostNotApplicableHint: 'Available only for OpenAI pool-mode accounts without image pool enabled.',
