...
export default {
  openCodeUsage: {
    "title": "OpenCode Go usage windows",
    "description": "Refresh subscription usage after real request activity. Both global and account switches must be on; idle accounts are not polled continuously.",
    "refresh": "Refresh now",
    "preferences": "Refresh settings",
    "auto": "Auto",
    "accountAuto": "Auto-refresh this account",
    "source": "Usage source",
    "configured": "Configured account endpoint",
    "official": "Official Go subscription",
    "officialHint": "Send this account’s API key to the official Go subscription endpoint on opencode.ai, using its configured proxy.",
    "configuredHint": "Use the account endpoint and proxy without changing model routing.",
    "globalOff": "Global auto-refresh is off. Manual refresh is available.",
    "fiveHour": "5 hours",
    "weekly": "Weekly",
    "monthly": "Monthly",
    "updated": "Updated {time}",
    "resets": "Resets {time}",
    "unknownReset": "No reset time reported by the provider",
    "notFetched": "Not fetched · use the refresh button",
    "failed": "Unable to load usage. Please retry.",
    "interval": "Maximum wait during activity (minutes)",
    "debounce": "Debounce after activity (minutes)",
    "saved": "Settings saved",
    "manualAvailable": "Off by default. Manual refresh remains available in the account list.",
    "invalid": "Maximum wait must be an integer from 5–1440; debounce must be an integer from 1–60."
},

  requestRetention: {
    invalid: 'Enter a whole number of retention days from 0 to 3650.',
    "systemDays": "System log retention days",
    "title": "Override request log retention",
    "description": "When off, use startup configuration. When enabled, 0 retains request details permanently. Billing deduplication archives are preserved. A preview appears before saving; cleanup runs in background batches.",
    "days": "Request retention days (0–3650)",
    "confirm": "Automatically remove request details before {cutoff}. Database statistics estimate approximately {rows} rows; this estimate may be inaccurate. Save this policy?",
    "unknown": "unknown"
},
  claudeVersion: {
    "title": "Claude CLI version",
    "description": "Check official stable releases hourly when enabled. Disabled by default; synchronization runs in the background.",
    "autoSync": "Automatically sync Claude CLI version",
    "manual": "Pin a version (optional)",
    "effective": "Effective version",
    "precedence": "A manual pin takes priority. When auto-sync is off, the stored synced version is inactive. Existing client fingerprint precedence is preserved.",
    "lastSynced": "Last synced:"
},
  backupArchive: {
    "title": "Monthly archives",
    "description": "Retain completed scheduled backups independently of ordinary retention. Disabled by default.",
    "days": "Archive days each month",
    "monthEnd": "Also archive at month end",
    "dateHint": "Short months use the last day. Archive dates are retention labels; data reflects the actual backup time. Missed prior months are not recreated.",
    "retainCount": "Archives to retain",
    "retentionHint": "0 keeps archives permanently. Disabling this feature preserves existing archives.",
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        configTomlHint: 'Put this content at the beginning of config.toml. After changing API Key configuration, fully restart Codex and create a new task.',
  ...
  usage: {
    ...
    totalTokens: 'Total Tokens',
    cacheTotal: 'Cache',
    cacheBreakdown: 'Cache creation: {creation} / cache read: {read}',
  ...
  monitorCommon: {
    ...
    checkMode: {
      probe: 'Availability',
      quota: 'Quota only',
      quota_probe: 'Availability + quota'
    },
    quota: {
  ...
  admin: {
    ...
    users: {
      ...
      columns: {
        ...
        usageKimi: 'Usage (Kimi)',
        usageZhipu: 'Usage (Zhipu)',
        usageDeepSeek: 'Usage (DeepSeek)',
        usageMiniMax: 'Usage (MiniMax)',
        concurrency: 'Concurrency',
        status: 'Status',
      ...
      bulkLimits: {
        title: 'Bulk edit user limits',
        action: 'Edit limits ({count})',
        actionAll: 'Bulk edit limits',
        scope: 'Apply to',
        selectedCount: '{count} users selected',
        allUsers: 'All users',
        selectUser: 'Select user {email}',
        enableConcurrency: 'Change concurrency',
        enableRPMLimit: 'Change RPM',
        unlimited: '0 means unlimited',
        nonNegativeInteger: 'Enter a non-negative integer',
        selectionLimit: 'Select at most {max} users',
        confirm: 'Update limits for {count} selected users?',
        confirmAll: 'Update limits for all users? This changes the concurrency and RPM settings read on their next request.',
        apply: 'Apply',
        applying: 'Applying...',
    ...
    groups: {
      ...
      form: {
        ...
        upstreamBillingGuardRange: 'Upstream Rate Guard Range',
        upstreamBillingGuardMinLabel: 'Minimum multiplier',
        upstreamBillingGuardMinPlaceholder: 'Minimum, blank is unlimited',
        upstreamBillingGuardMaxPlaceholder: 'Maximum, blank is unlimited',
        upstreamBillingGuardMaxLabel: 'Maximum',
        upstreamBillingGuardUnlimited: 'Blank means unprotected',
        upstreamBillingGuardHint: 'Supports API Key accounts on all eight platforms. Only this group pauses outside the range and recovers automatically inside it.',
        upstreamBillingGuardInvalid: 'Bounds must be at least 0; when both are set, the minimum must be less than the maximum',
        status: 'Status',
      ...
      duplicateSuccess: 'Created inactive copy "{name}"',
      ...
      imagePricing: {
        title: 'Media Generation Pricing',
        description: 'Configure image/video generation access and base prices. Leave empty to use default prices.',
        allowImageGeneration: 'Allow image generation for this group',
        batchImageTitle: 'Batch Images',
        batchImageDescription: 'Gemini groups only. When enabled, API keys in this group can submit batch image jobs. The discount multiplier is used for settlement; the hold multiplier reserves balance before submission.',
        allowBatchImageGeneration: 'Allow batch image generation for this group',
        batchImageDiscountMultiplier: 'Batch image discount multiplier',
        batchImageHoldMultiplier: 'Batch image hold multiplier',
        independentMultiplier: 'Use independent image multiplier',
        imageMultiplier: 'Image multiplier',
        videoIndependentMultiplier: 'Use independent video multiplier',
    ...
    channels: {
      ...
      form: {
        ...
        timePricing: 'Time multiplier (optional)',
        timePricingEnable: 'Enable',
        timePricingDisable: 'Disable',
        timePricingTimezonePlaceholder: 'IANA timezone, e.g. Asia/Shanghai',
        timePricingStartPlaceholder: 'Start time',
        timePricingEndPlaceholder: 'End time',
        timePricingMultiplierPlaceholder: 'Multiplier',
        timePricingAddPeriod: 'Add period',
    ...
    channelMonitor: {
      ...
      linkedAccountRequired: 'Please select a quota account',
      columns: {
        name: 'Name',
        provider: 'Provider',
        primaryModel: 'Primary Model',
      ...
      form: {
        ...
        checkModeProbe: 'Availability',
        checkModeProbeHint: 'Send a lightweight model request and measure availability and latency.',
        checkModeQuota: 'Quota only',
        checkModeQuotaHint: 'Read account quota or balance without consuming model tokens.',
        checkModeQuotaProbe: 'Availability + quota',
        checkModeQuotaProbeHint: 'Keep the availability check and attach an account quota snapshot.',
        linkedAccount: 'Quota account',
        linkedAccountPlaceholder: 'Search accounts on this platform',
        linkedAccountHint: 'Quota checks run independently from request routing and scheduling.',
        linkedAccountMissing: 'The linked account could not be loaded. Select it again.',
        linkedAccountEmpty: 'No matching accounts are available on this platform.',
    ...
    accounts: {
      ...
      revertProxyFallback: 'Restore Proxy',
      revertProxyFallbackSuccess: 'Original proxy restored',
      revertProxyFallbackFailed: 'Failed to restore original proxy',
      ...
      status: {
        ...
        billingGuardBlocked: 'Rate guard paused',
        quotaExceeded: 'Quota Exceeded',
        poolSoftCooldown: 'Pool Cooldown',
        poolRecoveryProbing: 'Probing',
        poolRecoveryPending: 'Probe Pending',
        unschedulable: 'Unschedulable',
        rateLimitedUntil: 'Rate limited and removed from scheduling. Auto resumes at {time}',
        rateLimitedAutoResume: 'Auto resumes in {time}',
        poolSoftCooldownAutoProbe: 'Probe in {time}',
        poolRecoveryProbingShort: 'Recovery probe running',
        poolRecoveryPendingShort: 'Waiting for recovery probe',
        poolSoftCooldownReason: 'Pool-mode soft cooldown; returns after a successful probe',
        poolSoftCooldownCode: 'Pool-mode soft cooldown, status {code}',
        poolSoftCooldownReasonWithCode: 'Pool-mode soft cooldown, status {code}: {reason}',
      ...
      upstreamBilling: {
        ...
        syncRateHint: 'Write the converted upstream base rate to this account after a successful probe. The rate is system-managed while enabled.',
        syncRateManagedHint: 'This rate is managed by upstream probing. Disable automatic sync to edit it manually.',
        adaptiveSchedulingFactor: 'Upstream rate conversion',
        adaptiveSchedulingFactorHint: 'The converted upstream rate is shared by adaptive scheduling, group rate guards, admin display, and auto-sync; the raw probe value remains available for audit.',
        adaptiveSchedulingObserved: 'Raw upstream probe: {rate}',
        adaptiveSchedulingEffective: 'Converted upstream rate: {rate}',
        adaptiveSchedulingFactorInvalid: 'The upstream rate conversion factor must be between 0.001 and 100.',
        manualMultiplier: 'Manual upstream rate',
        manual: 'Manual',
        manualMultiplierHint: 'Using the administrator-provided final scheduling rate; the conversion factor is not applied.',
        manualMultiplierUnsupportedHint: 'When automatic upstream rate discovery is unsupported, enter the final scheduling rate; leave blank to remain unknown.',
        manualMultiplierPlaceholder: 'Blank means unknown',
        ...
        failedWithLast: 'Probe failed · keeping last rate',
        guard: 'Rate guard',
        guardHint: 'Stop new scheduling outside the protected range and resume automatically after recovery.',
        groupGuardHint: 'When enabled, applies the protected range of every bound group. Groups without a range remain unrestricted.',
        advancedOverrides: 'Advanced account-group range',
        inheritDefault: 'Default range: {rate}',
        inheritPlaceholder: 'Max: inherit',
        overrideLabel: 'Protected maximum override for {group}',
        overrideHint: 'Leave blank to inherit. A minimum can only increase, a maximum can only decrease, and an unconfigured side cannot be overridden.',
        guardMaxMultiplier: 'Maximum protected multiplier',
        guardObserved: 'Current effective rate {rate}x',
        guardRequiresAutoProbe: 'Enable account automatic probing before enabling the rate guard',
        blankMeansUnlimited: 'Blank means unlimited',
        unlimited: 'Unlimited',
        selectGroupFirst: 'No groups are currently selected',
        noConfiguredGroup: 'None of the selected groups has a protected multiplier configured',
        groupNotConfigured: 'No protected multiplier configured for this group',
        invalidGuardLimit: 'The protected multiplier must be a number greater than or equal to 0',
        currentRateDetail: 'Current upstream rate: {rate}',
        guardLimitDetail: 'Protected range: {rate}',
        guardBelowMin: 'Below the protected minimum; scheduling is paused in this group',
        guardProbeDisabled: 'Automatic probing is off; scheduling is paused in this group',
        guardGlobalProbeDisabled: 'Global probing is off; showing the last observed rate',
        guardDisabled: 'Account protection is disabled',
        guardWaitingFirstProbe: 'Waiting for the first successful probe; scheduling remains available',
        guardPaused: 'Above the protected limit; scheduling is paused in this group',
        guardAvailable: 'Within the protected limit; scheduling is available in this group',
        minimumOnlyRange: 'At least {rate}; no maximum',
        minInheritPlaceholder: 'Min: inherit',
        minUnavailablePlaceholder: 'No minimum configured',
        maxUnavailablePlaceholder: 'No maximum configured',
        minOverrideLabel: 'Protected minimum override for {group}',
        overrideRangeInvalid: 'The effective minimum must be less than the effective maximum',
      ...
      bulkEdit: {
        ...
        shadowWarning: 'Selection includes Spark shadow accounts. Shadow accounts only receive safe scheduling fields and model mapping; proxy, credential, and upstream feature changes are ignored for them.'
      },
      ...
      cnProviders: {
        ...
        codingPlanDesc: 'Subscription coding plan with rolling usage-window limits.',
        apiProtocol: 'API protocol',
        adaptive: 'Adaptive',
        adaptiveDesc: 'Choose the matching endpoint from the downstream request protocol.',
        adaptiveEndpoints: 'Adaptive protocol endpoints',
        adaptiveEndpointsDesc: 'Route each downstream protocol to its own endpoint; blank values use provider defaults.',
        chatCompletions: 'Chat Completions',
        chatCompletionsDesc: 'Standard OpenAI-compatible endpoint.',
        anthropic: 'Anthropic',
        anthropicDesc: 'Native Anthropic endpoint from the provider.',
        responses: 'Responses',
        responsesDesc: 'OpenAI Responses-compatible endpoint.',
        baseUrlHint: 'Use an official URL, a preset below, or a compatible gateway URL.',
        apiKeyHint: 'Enter the API key for this provider.',
        presets: 'Base URL presets',
      ...
      openai: {
        ...
        firstTokenTimeoutStages: {
          ...
          remove: 'Remove stage',
          placeholderRange: 'Placeholder must be between 1 and 100000 ms.',
          guardRange: 'Guard limit must be a positive integer and has no configured maximum.',
          guardBelowPlaceholder: 'Guard limit cannot be lower than the placeholder.',
          placeholderOrder: 'Must be greater than stage {stage} placeholder.',
          guardOrder: 'Must be greater than stage {stage} guard limit.',
          conflict: 'Stage {stage} and later contain ordering conflicts that must be resolved before saving.',
          repair: 'Repair later stages',
          removeInvalid: 'Remove invalid stages',
          countInvalid: 'The policy must contain between 1 and 10 stages.',
          stagePlaceholderInvalid: 'Stage {stage} placeholder must be between 1 and 100000 ms.',
          stageGuardInvalid: 'Stage {stage} guard limit must be a positive integer.',
          stageGuardBelow: 'Stage {stage} guard limit cannot be lower than its placeholder.',
          stageOrderInvalid: 'Both values in stage {stage} must be greater than stage {previous}.'
        },
        ...
        seedanceDescription: 'Native asynchronous video generation · Dedicated tasks and billing',
        seedanceRequirements: 'Requires an API key, custom upstream URL, model mapping and explicit token or per-request pricing. Generation incurs charges; ordinary account probes never create videos.',
        seedanceUnchanged: 'Seedance: unchanged',
        seedanceEnabled: 'Seedance: enabled',
        seedanceDisabled: 'Seedance: disabled',
        seedanceTestTitle: 'Seedance integration test',
        seedanceTestHint: 'Test creation, retrieval and billing through the downstream API. Normal group scheduling applies, so this account is not guaranteed. The key is used only in this dialog and is not saved.',
        seedanceDownstreamKey: 'Your downstream API key (OpenAI group)',
        seedanceCostConsent: 'I confirm that creating a real video incurs upstream charges and is billed at the current group price.',
        seedanceCreateTask: 'Create video task',
        seedanceRecoverSubmission: 'Check the same submission (no duplicate task)',
        seedanceCancelTask: 'Request cancellation',
        seedanceNewTask: 'Prepare another task',
        seedanceTaskPersistence: 'Save the task ID. Closing this dialog does not cancel submitted tasks; background retrieval and settlement continue.',
        seedanceCancellationPending: 'Cancellation requested. Final provider status and actual usage will still be reconciled; cancellation is not necessarily free.',
      ...
      promptCacheAdvancedFeatures: 'Advanced Cache Enhancements',
      promptCacheSmartRouting: 'Smart Cache Routing',
      promptCacheSmartRoutingHint: 'Prefers proven warm accounts among healthy accounts at the same priority.',
      promptCacheAccountRelay: 'Warm Account Relay',
      promptCacheAccountRelayHint: 'Tries other cache-warm peer accounts when the current warm account is unavailable.',
      promptCacheKeyOptimization: 'Cache Key Optimization',
      promptCacheKeyOptimizationHint: 'Ignores non-prompt controls to reduce fragmentation of identical static prefixes.',
      promptCacheLongContextEnhancement: 'Long Context Enhancement',
      promptCacheLongContextEnhancementHint: 'Keeps full history earlier only for proven cache hits without adding new trimming.',
      promptCacheCreationOptimization: 'Upstream Cache Creation Optimization',
      promptCacheCreationOptimizationHint: 'Applies to OpenAI OAuth and API-key text accounts. Off preserves current request behavior exactly; on reduces GPT-5.6 cache creation where supported.',
      promptCacheCreationOptimizationReduce: 'Reduce Cache Creation',
      promptCacheCreationOptimizationReduceHint: 'Mode A (default): uses explicit + 24h, removes old breakpoints, and places one breakpoint only after a sufficiently large contiguous system/developer prefix to reduce repeated creation while retaining stable-prefix reuse.',
      promptCacheCreationOptimizationSuppress: 'Suppress Cache Creation',
      promptCacheCreationOptimizationSuppressHint: 'Mode B: uses explicit + 24h, removes legacy retention and every cache breakpoint, and never adds a new one to minimize repeated cache creation. Cache creation may still occur if the upstream ignores these fields or compatibility fallback is triggered because explicit mode is unsupported.',
      promptCacheCreationOptimizationFree: 'Free Downstream Writes',
      ...
      downstreamCacheMarkup: 'Downstream high-cache markup',
      downstreamCacheMarkupHint: 'Adds downstream usage after cache reads reach the threshold. Local usage, cost, and account statistics stay unchanged.',
      downstreamCacheMarkupThreshold: 'Cache-read threshold',
      downstreamCacheMarkupPercent: 'Markup percentage',
      downstreamCacheMarkupAllocation: 'Markup cost allocation',
      downstreamCacheMarkupInput: 'Regular input',
      downstreamCacheMarkupRead: 'Cache read',
      downstreamCacheMarkupOutput: 'Output',
      downstreamCacheMarkupZeroHint: 'The current 0% rate does not add downstream usage.',
      ...
      anthropicCacheBoostEnabledHint: 'This Anthropic account will optimize cache_control breakpoints automatically.',
      anthropicCacheBoostDisabledHint: 'Cache boost is disabled for this Anthropic account.',
      promptCacheBoostEnabled: 'Enabled',
      promptCacheBoostEnabledHint: 'This OpenAI account will boost prompt cache hits automatically.',
      promptCacheBoostDisabled: 'Off',
      promptCacheBoostDisabledHint: 'Cache boost is disabled for this OpenAI account.',
      promptCacheBoostNotApplicable: 'N/A',
      promptCacheBoostNotApplicableHint: 'Available only for OpenAI OAuth, Anthropic OAuth/Setup Token, or API-key text pools.',
      upstreamStrongIsolation: 'Upstream Isolation',
      upstreamStrongIsolationHint: 'Use only for problematic upstreams. Removes upstream continuation signals and forces stateless requests while keeping static cache boost.',
      anthropicUpstreamStrongIsolation: 'Anthropic Upstream Isolation',
      anthropicUpstreamStrongIsolationHint: 'Isolates Anthropic upstream session/conversation signals. It does not remove cache_control, so Anthropic cache boost remains available.',
      anthropicUpstreamStrongIsolationEnabledHint: 'This Anthropic account will not send session/conversation signals upstream.',
      anthropicUpstreamStrongIsolationDisabledHint: 'This Anthropic account forwards upstream session signals normally.',
      upstreamStrongIsolationEnabled: 'Isolated',
      upstreamStrongIsolationEnabledHint: 'This account will not send session/conversation/previous_response continuation signals upstream.',
      upstreamStrongIsolationDisabled: 'Not isolated',
      ...
      upstreamStrongIsolationNotApplicableHint: 'Available only for OpenAI OAuth, Anthropic OAuth/Setup Token, or API-key text pools.',
      ...
      upstreamConcurrencyRaceRetryCount: 'Total Race Retry Attempts',
      upstreamConcurrencyRaceRules: 'Same-Account Retry Conditions',
      upstreamConcurrencyRaceRulesHint: 'Only applies with upstream race enabled. Exact status rules take precedence over 5xx; all HTTP rules share the race retry budget.',
      upstreamConcurrencyRaceRuleMatcher: 'HTTP status rule',
      upstreamConcurrencyRaceRuleLimit: 'Retry limit',
      upstreamConcurrencyRaceRule5xx: 'All server errors',
      upstreamConcurrencyRaceRulePlaceholder: 'Enter a status code or 5xx',
      upstreamConcurrencyRaceAddRule: 'Add rule',
      upstreamConcurrencyRaceRemoveRule: 'Remove rule {matcher}',
      upstreamConcurrencyRaceNoRules: 'No status rules added',
      upstreamConcurrencyRaceRuleInvalid: 'Enter a status code from 100–599 or 5xx',
      upstreamConcurrencyRaceRuleExists: 'That status rule already exists',
      upstreamConcurrencyRaceRuleBudget: 'HTTP rules use {used}/{total} retries',
      upstreamConcurrencyRaceRuleBudgetExceeded: 'Rule totals exceed the retry budget. Increase the total or reduce another rule.',
      upstreamConcurrencyRaceRuleBudgetFull: 'The retry budget is fully allocated; new rules start at 0.',
      upstreamConcurrencyRaceTransport: 'Automatically retry transient system errors',
      upstreamConcurrencyRaceTransportHint: 'Only handles connection failures, no response, and recoverable errors without an HTTP status.',
      upstreamConcurrencyRaceTransportCount: 'Transient system-error retries',
      upstreamConcurrencyRaceTransportBudgetExceeded: 'Transient system-error retries cannot exceed the total race retry limit.',
      ...
      grokCustomBaseUrl: {
        ...
        hint: 'Account traffic (chat, media, and probes) is forwarded to this address. OAuth authorization and token refresh remain on official endpoints.',
      ...
      oauth: {
        ...
        openai: {
          ...
          errors: {
            ...
            OPENAI_DEVICE_AUTH_PENDING: 'Device authorization is still pending. Complete it in the browser, then click Complete Authorization again.',
            OPENAI_DEVICE_AUTH_SLOW_DOWN: 'Polling too quickly. Wait a few seconds and try again.',
            OPENAI_DEVICE_AUTH_EXPIRED: 'The device code has expired. Generate a new one.',
            OPENAI_DEVICE_AUTH_DENIED: 'Device authorization was denied. Generate a new code and try again.'
          },
          // Refresh Token auth
          ...
          deviceCodeStarting: 'Generating...',
          deviceVerificationUrl: 'Verification URL',
          deviceUserCode: 'Device Code',
          deviceCodeHint: 'The device code usually expires in {seconds} seconds.',
          deviceCodeSecurityNotice: 'Device codes can be stolen by phishing. Never share this code; enter it only on your own OpenAI/Codex login page.',
      ...
      grokUploadMedia: 'Upload test media',
      grokUploadFirstFrame: 'Upload first-frame image (optional)',
      grokPromptLabel: 'Test prompt',
      grokPromptPlaceholder: 'Enter a test prompt, or leave blank for the default',
      grokDirectTestHint: 'This tests the selected account directly. Downstream requests also depend on groups, scheduling, cooldowns and quotas.',
      grokAudioRequired: 'Upload an audio file up to 8 MB.',
      grokMediaOptional: 'Optional image, up to 8 MB. Uploading keeps your prompt.',
      grokMediaWrongType: 'The file type does not match the test mode.',
      grokMediaReadFailed: 'Could not read the file. Please upload it again.',
      testStreamTooLarge: 'Test response is too large. Please use a smaller request.',
      testStreamIncomplete: 'The test stream ended without a completion result. Please retry.',
      grokTestIncomplete: 'The test connection ended without a result. Check the server logs.',
      ttsSuccess: 'TTS request succeeded',
      grokMediaTooLarge: 'Test media must be 8 MB or smaller',
      imageReceived: 'Received test image #{count}',
      grokTestMode: 'Grok test mode',
      grokModes: { responses: 'Responses text', chat: 'Chat text', image: 'Image', video: 'Video', search: 'Search', tts: 'TTS', stt: 'STT', realtime: 'Realtime' },
      // Stats Modal
    ...
    usage: {
      ...
      upstreamResponseModel: 'Response Model',
      upstreamModelMismatch: 'Model Match',
      mismatch: 'Mismatch',
      match: 'Match',
      auditUnavailable: 'Not observed',
      ipAddress: 'IP',
    ...
    settings: {
      ...
      features: {
        ...
        promptAudit: {
          title: 'Prompt Audit',
          description: 'Inspect prompts asynchronously for security risks. Disabled by default.',
          configureLink: 'Open Prompt Audit',
          enabled: 'Enable Prompt Audit',
          enabledHint: 'When off, the admin page and asynchronous prompt collection are disabled.',
        },
        affiliate: {
      ...
      scheduling: {
        ...
        openAIPoolSoftCooldownMax: 'OpenAI Non-Image Pool Max Soft Cooldown Seconds',
        openAIPoolProbeTimeout: 'OpenAI Non-Image Pool Probe Timeout Seconds',
      ...
      gatewayConcurrency: {
        ...
        userWaitHint: '1-30000ms; fail fast with 429 instead of holding the connection.',
        accountWait: 'Account slot wait',
        accountWaitHint: '1-30000ms for account fallback paths.',
        edgeBudget: 'Edge queue budget',
        edgeBudgetHint: '1-30000ms; restart Edge after deployment changes.',
        globalWorkers: 'Edge global concurrency',
        globalWorkersHint: '1-999999999; relay workers awaiting upstream headers per Edge replica. Active streams are tracked separately. Restart Edge after saving.',
        ...
        edgeRestartHint: 'User/account waits and Retry-After apply to Go immediately. Update SUB2API_EDGE_QUEUE_WAIT_BUDGET_MS and SUB2API_EDGE_GLOBAL_WORKERS, then restart the Edge container.',
        userWaitRange: 'User slot wait must be between 1 and 30000ms.',
        accountWaitRange: 'Account slot wait must be between 1 and 30000ms.',
        edgeBudgetRange: 'Edge queue budget must be between 1 and 30000ms.',
      ...
      gatewayEdgeProtection: {
        ...
        connectTimeoutHint: 'Milliseconds; must be greater than 0 and bounds Edge connection and connection-resource waits.',
        headerTimeout: 'Response-header timeout',
        headerTimeoutHint: 'Milliseconds; must be greater than 0 and is the maximum wait for headers on one upstream attempt.',
        headerBudget: 'Response-header total budget',
        headerBudgetHint: 'Milliseconds; starts with the first real upstream attempt and is shared by all failover attempts.',
        bodyIdleTimeout: 'Body idle timeout',
        bodyIdleTimeoutHint: 'Milliseconds; must be greater than 0 and only bounds continuous silence, not total stream duration.',
        maxAttempts: 'Max header attempts',
        maxAttemptsHint: 'Maximum real upstream attempts allowed within the total budget when response-header timeouts occur.',
        failover: 'Fail over on header timeout',
        failoverHint: 'Before downstream output is committed, use the existing account failover path.',
        exposeRetriedUsage: 'Expose accumulated retry usage downstream',
        exposeRetriedUsageHint: 'When enabled, the final usage includes all real upstream usage observed during this logical request. Only one final response is sent, so no duplicate downstream bill is created.',
        exposeRetriedUsageOn: 'Accumulated usage shown',
        exposeRetriedUsageOff: 'Final attempt only',
        behaviorHint: 'SSE comment preflush and empty-token placeholders keep their existing settings and semantics; failover only happens before downstream commit.',
        timeoutRange: 'Edge connect, response-header timeout, and total budget must be safe integers greater than 0.',
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptInjectionHint: 'Inject Claude Code-shaped system blocks for non-Claude-Code Claude OAuth requests. Default off; enabling increases upstream input prompt size.',
        claudeOAuthSystemPrompt: 'Claude Code Expansion Prompt',
        claudeOAuthSystemPromptPlaceholder: 'Leave empty to use the built-in Claude Code expansion prompt.',
        claudeOAuthSystemPromptHint: 'Legacy compatibility: used by the claude_code_expansion_prompt placeholder.',
        claudeOAuthSystemPromptBlocks: 'Claude OAuth System Blocks',
        claudeOAuthSystemPromptBlocksPlaceholder: 'Leave empty to use the built-in three-block default.',
        claudeOAuthSystemPromptBlocksHint: 'Leave empty to use the built-in three-block default. Supports billing_header, cc_version, fp, claude_code_system_prompt, and claude_code_expansion_prompt placeholders.',
        claudeOAuthSystemBlockTitle: 'System Block {index}',
        claudeOAuthSystemBlockCustom: 'Custom',
        claudeOAuthSystemBlockToggleVisible: 'Collapse or expand',
        claudeOAuthSystemBlockMoveUp: 'Move up',
        claudeOAuthSystemBlockMoveDown: 'Move down',
        claudeOAuthSystemBlockDelete: 'Delete',
        claudeOAuthSystemBlockPreset: 'Preset',
        claudeOAuthSystemBlockType: 'Type',
        claudeOAuthSystemBlockTypeText: 'Text',
        claudeOAuthSystemBlockContent: 'Content',
        claudeOAuthSystemBlockCacheControl: 'Cache Control',
        claudeOAuthSystemBlockCache5m: '5 minutes',
        claudeOAuthSystemBlockCache1h: '1 hour',
        claudeOAuthSystemBlockAdd: 'Add block',
        claudeOAuthSystemBlockRestore: 'Restore default',
        claudeOAuthSystemPresetBillingHeader: 'Billing Header',
        claudeOAuthSystemPresetIdentity: 'Claude Code Identity Prompt',
        claudeOAuthSystemPresetExpansion: 'Claude Code Expansion Prompt',
        claudeOAuthSystemPresetCustom: 'Custom',
        ...
        clientDatelineNormalizationHint: 'Normalize client dateline fingerprint variants in Anthropic OAuth/Setup Token request bodies without rewriting ordinary user text.',
        ...
        openaiCodexVersionTitle: 'Codex outbound version',
        openaiCodexVersionDesc: 'Applies only to identity headers on OpenAI OAuth / ChatGPT internal paths. API keys and other platforms are unaffected.',
        openaiCodexAutoSync: 'Sync stable releases',
        openaiCodexManualVersion: 'Pinned version',
        openaiCodexManualVersionPlaceholder: 'Empty uses synced value or built-in 0.146.0',
        openaiCodexSyncedVersion: 'Last synced version',
        openaiCodexNotSynced: 'Not synced',
        openaiCodexVersionPrecedence: 'Precedence: pinned version > last synced version > built-in 0.146.0. Sync is enabled by default, checks every 6 hours, and never downgrades.',
        ...
        codexHardeningDesc: "Only affects OpenAI OAuth accounts with 'Codex official clients only' enabled. Beyond User-Agent/Originator, harden the decision with a version range, an engine-fingerprint gate, and black/whitelists.",
        ...
        codexVersionHint: 'Official clients only: checks their version against the [min, max] range. Leave either side empty to not limit it.',
        codexFingerprintSignals: 'Codex engine fingerprint signals',
        codexFingerprintSignalsDesc: "Define engine-fingerprint signals: every Required signal must match (AND); within a row, '/'-separated variants are OR'd. None checked means not enforced. Default checks only the x-codex- prefix.",
        ...
        codexFingerprintNoRequiredWarn: 'No signal is marked Required, so the engine-fingerprint gate is inactive. Check at least one signal to enable it.',
        codexAllowAppServer: 'Codex app-server',
        codexAllowAppServerDesc: "Allow third-party clients that embed the Codex engine and connect over the app-server protocol (e.g. Claude Code's codex plugin). Off by default.",
        ...
        codexWhitelistSkipFingerprintTooltip: 'Risk: when checked this entry is allowed on originator + User-Agent alone, with no engine-fingerprint backstop. Use only for trusted third-party clients.',
      ...
      payment: {
        ...
        subscriptionUsdToCnyRateHint: 'Applies only to subscription orders. 0 disables conversion; CNY gateways charge the plan price directly. When set, CNY gateways charge price × rate.',
        subscriptionUsdToCnyPreview: 'Preview: subscription 1 USD = {cny} CNY',
        disabled: 'Empty or 0 = disabled',
      ...
      betaPolicy: {
        ...
        userIdsHint: 'Leave empty for all users. When set, only API keys owned by these users match; user-specific rules take precedence over global rules.',
  ...
  payment: {
    ...
    admin: {
      ...
      refundPending: 'Refund submitted and waiting for provider confirmation',
