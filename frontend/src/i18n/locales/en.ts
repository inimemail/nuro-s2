...
export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      promptCacheCreationOptimizationInput125Hint: 'Mode D: uses Mode B upstream. Whenever cache creation is present, downstream usage reports zero creation and redistributes its GPT-5.6 price-equivalent cost across regular input, a small output share, and cache reads. Account-scoped only.',
