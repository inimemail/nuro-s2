export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      promptCacheBoostNotApplicableHint: 'Available only for OpenAI OAuth accounts or OpenAI API-key text pools.',
      ...
      upstreamStrongIsolationNotApplicableHint: 'Available only for OpenAI OAuth accounts or OpenAI API-key text pools.',
