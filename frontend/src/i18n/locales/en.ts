export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      promptCacheCreationOptimizationSuppressHint: 'Mode B: uses explicit + 24h, removes every cache breakpoint, and never adds a new one for maximum cache-creation suppression. Upstream source code that ignores these fields may still create cache entries.',
