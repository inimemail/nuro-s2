    ...
    accounts: {
      ...
      openai: {
        ...
        firstTokenTimeoutStages: {
          ...
          description: 'Automatically selects a stage from the latest real first-token latency. Placeholder injection pauses above the final guard and resumes at a lower stage after recovery. Up to 10 stages.',
          automatic: 'Automatic',
          add: 'Add stage',
          stage: 'Stage {stage}',
          placeholder: 'Placeholder',
          guard: 'Guard limit',
          remove: 'Remove stage',
          placeholderRange: 'Placeholder must be between 1 and 3000 ms.',
          guardRange: 'Guard limit must be between 1 and 30000 ms.',
          ...
          stagePlaceholderInvalid: 'Stage {stage} placeholder must be between 1 and 3000 ms.',
          stageGuardInvalid: 'Stage {stage} guard limit must be between 1 and 30000 ms.',
