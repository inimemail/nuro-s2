  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamBilling: {
        ...
        adaptiveSchedulingFactor: 'Scheduling rate factor',
        adaptiveSchedulingFactorHint: 'Used only for health-first and health/cost-balanced scheduling comparisons; billing, rate guards, and auto-sync are unchanged.',
        adaptiveSchedulingObserved: 'Upstream probe: {rate}',
        adaptiveSchedulingEffective: 'Scheduling rate: {rate}',
        adaptiveSchedulingFactorInvalid: 'The scheduling rate factor must be between 0.001 and 100.',
