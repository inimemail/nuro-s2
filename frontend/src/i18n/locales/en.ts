  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamBilling: {
        ...
        guard: 'Rate guard',
        guardHint: 'Stop new scheduling above the threshold and resume automatically after recovery.',
        groupGuardHint: 'When enabled, automatically applies the configured limit of every bound group. Groups without a limit remain unrestricted.',
        advancedOverrides: 'Advanced account-group limits',
        inheritDefault: 'Default limit: {rate}',
        inheritPlaceholder: 'Inherit',
        overrideLabel: 'Custom limit for {group}',
        overrideHint: 'Leave blank to inherit the group default. A custom limit cannot exceed it.',
        ...
        guardLimitDetail: 'Protected limit: {rate}',
