  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamBilling: {
        ...
        groupGuardHint: 'Set a separate limit for each group currently bound to this account. Blank means unlimited; unbinding a group deletes its guard.',
        ...
        unlimited: 'Unlimited',
        selectGroupFirst: 'Select at least one group first',
