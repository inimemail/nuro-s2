...
export interface User {
  ...
  frozen_balance?: number // Balance reserved by async/batch jobs
...
export interface OllamaCloudUsageState {
  ...
  rate_limit_recovery_enabled?: boolean
  encryption_key_configured: boolean
  snapshot?: OllamaCloudUsageSnapshot
}
export interface OllamaCloudUsageSettings { enabled: boolean; interval_minutes: number; debounce_minutes: number }
...
export interface AdminGroup extends Group {
  edge_protection_enabled?: boolean | null
  // 模型路由配置（仅管理员可见，内部信息）
...
export interface Account {
  ...
  non_openai_pool_soft_cooldown_until?: string | null
...
export interface AccountUsageInfo {
  ...
  codex_reset_credit_expirations?: string[] | null
