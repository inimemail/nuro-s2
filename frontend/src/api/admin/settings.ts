...
export const PLATFORM_QUOTA_PLATFORMS: readonly PlatformType[] = ["anthropic", "openai", "gemini", "antigravity", "grok", "kimi", "zhipu", "deepseek", "minimax", "opencode_go"]
...
export interface SystemSettings {
  ...
  claude_cli_client_version: string;
  openai_codex_client_version_synced: string;
  claude_cli_client_version_synced: string;
  openai_codex_client_version_effective: string;
  claude_cli_client_version_effective: string;
  openai_codex_client_version_source: string;
  claude_cli_client_version_source: string;
  openai_codex_version_auto_sync_enabled: boolean;
  claude_cli_version_auto_sync_enabled: boolean;
  ...
  // Model Plaza feature switch and public copy
