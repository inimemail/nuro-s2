...
var grokTextModelAliases = map[string]string{
	...
	"grok-4.3-latest": "grok-4.3", "grok-build": "grok-build-0.1", "grok-build-latest": "grok-build-0.1",
...
func DefaultModelMapping() map[string]string {
	...
	// Historical IDs remain accepted, but do not clutter the native picker.
	mapping["grok-imagine"] = "grok-imagine"
