...
// raw JSON string control bytes before strict JSON validation.
...
// OpenAI-compatible clients sometimes place inside JSON strings. Both the
// input body and normalized output are capped by maxNormalizedBytes.
