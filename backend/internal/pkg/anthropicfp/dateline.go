// Package anthropicfp provides helpers for suppressing client-side fingerprints
// that would otherwise be visible to upstream Anthropic through a gateway.
package anthropicfp
...
// NormalizeDateline rewrites fingerprinted Anthropic client dateline sentences
// back to the canonical ASCII form.
