...
type OAuthSession struct {
	...
	DevicePollInterval int64     `json:"device_poll_interval,omitempty"`
...
// DeviceAuthStartResponse represents the device-code bootstrap response
// returned by OpenAI's Codex device authorization endpoint.
...
// DeviceAuthTokenResponse represents a successful device polling response.
...
// FlexibleInt accepts both JSON numbers and numeric strings. OpenAI Codex's
// device-code responses have used string durations in the public CLI.
