	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldUpstreamBillingGuardMinMultiplier,
				...
				group.FieldEdgeProtectionEnabled,
				...
				group.FieldAccountSchedulingStrategy,
				group.FieldAdaptiveTtftSwitchEnabled,
				group.FieldAdaptiveTtftSwitchThresholdSeconds,
				group.FieldAdaptiveHealthSampleFreshnessMinutes,
				group.FieldRpmLimit,
