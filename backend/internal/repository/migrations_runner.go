...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// 223 originally accepted strict_priority/health_first. The follow-up
	// health-cost scheduling change only broadens that allow-list and updates
	// the comment, so already-applied databases need no data migration.
	"223_group_account_scheduling_strategy.sql": newMigrationChecksumCompatibilityRule("d1d93bed2bdb5598c8a4c1a21997ece99c68936c02543a77cec63688964e94fd", "b84d8404e2f89277c42d931c16e56200909f9f9610ced8f829cdc96c1f2afed"),
}
