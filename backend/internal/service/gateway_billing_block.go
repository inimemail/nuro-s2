...
//
//	{"type":"text","text":"x-anthropic-billing-header: cc_version=2.1.92.{fp}; cc_entrypoint=cli;"}
//
// 新版 Claude Code CLI 已取消 cch=... 签名字段；继续注入会让 mimic 请求
// 偏离真实 CLI 流量。cc_version + cc_entrypoint 仍保留作为客户端归因信号。
//
