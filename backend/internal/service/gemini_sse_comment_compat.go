...
func downstreamRejectsSSEComments(c *gin.Context) bool {
	...
	// SDK identity and runtime hints can be split between these two headers.
	return geminiClientRejectsSSEComments(c.GetHeader("User-Agent") + " " + c.GetHeader("X-Goog-Api-Client"))
}
