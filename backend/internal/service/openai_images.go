...
func (s *OpenAIGatewayService) handleOpenAIImagesNonStreamingResponse(ctx context.Context, resp *http.Response, c *gin.Context, account *Account, upstreamModel string) (OpenAIUsage, int, []string, error) {
