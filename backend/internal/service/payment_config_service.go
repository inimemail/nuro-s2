...
const (
	...
	// SettingSubscriptionUSDToCNYRate is explicit opt-in: 0/empty keeps existing subscription direct-pay behavior.
	...
	SettingAlipayMobilePrecreate    = "ALIPAY_MOBILE_PRECREATE_DEEP_LINK"
)
...
func (s *PaymentConfigService) parsePaymentConfig(vals map[string]string) *PaymentConfig {
	cfg := &PaymentConfig{
		...
		AlipayMobilePrecreateDeepLink: vals[SettingAlipayMobilePrecreate] == "true",
	}
...
func (s *PaymentConfigService) UpdatePaymentConfig(ctx context.Context, req UpdatePaymentConfigRequest) error {
	...
	if req.AlipayMobilePrecreateDeepLink != nil {
		m[SettingAlipayMobilePrecreate] = formatBoolOrEmpty(req.AlipayMobilePrecreateDeepLink)
	}
