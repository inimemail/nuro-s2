...
type OpenAIOAuthClient interface {
	...
	StartDeviceAuth(ctx context.Context, proxyURL string) (*openai.DeviceAuthStartResponse, error)
	PollDeviceAuth(ctx context.Context, deviceAuthID, userCode, proxyURL string) (*openai.DeviceAuthTokenResponse, error)
}
