		...
		},
		{
			...
			account: &Account{
				...
				Credentials: map[string]any{
					"pool_mode":                             true,
					"upstream_concurrency_race_enabled":     true,
					"upstream_concurrency_race_retry_count": 999,
				},
			},
		...
		},
		{
			...
			account: &Account{
				...
				Credentials: map[string]any{
					"pool_mode":                             true,
					"upstream_concurrency_race_enabled":     true,
					"upstream_concurrency_race_retry_count": 0,
				},
			},
			expected: 1,
		},
		{
			...
			account: &Account{
				...
				Credentials: map[string]any{
					"pool_mode":                             true,
					"upstream_concurrency_race_enabled":     true,
					"upstream_concurrency_race_retry_count": 200,
				},
			},
			expected: 200,
		},
		{
			name: "race_mode_missing_independent_retry_count_uses_race_default",
			account: &Account{
				Type:     AccountTypeAPIKey,
				Platform: PlatformOpenAI,
				Credentials: map[string]any{
		...
		},
		{
			...
			account: &Account{
				...
				Credentials: map[string]any{
					"pool_mode":                             true,
					"upstream_concurrency_race_enabled":     true,
					"upstream_concurrency_race_retry_count": "oops",
				},
			},
			expected: defaultPoolModeRaceRetryCount,
		},
