...
func isCloudflareChallengeResponse(cfMitigated, body string) bool {
	...
	return strings.Contains(lower, "cloudflare") || strings.Contains(lower, "cf-chl-") ||
		strings.Contains(lower, "/cdn-cgi/challenge-platform/") || strings.Contains(lower, "just a moment")
}
