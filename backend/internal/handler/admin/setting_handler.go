...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		NonOpenAIPool:                                         settings.NonOpenAIPool,
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	openAIHeaderEnabled := previousSettings.GatewayOpenAIResponseHeaderTimeoutEnabled
	if req.GatewayOpenAIResponseHeaderTimeoutEnabled != nil {
		openAIHeaderEnabled = *req.GatewayOpenAIResponseHeaderTimeoutEnabled
	}
	...
	edgeLocalDataPlaneEnabled := previousSettings.GatewayEdgeLocalDataPlaneEnabled
	if req.GatewayEdgeLocalDataPlaneEnabled != nil {
		edgeLocalDataPlaneEnabled = *req.GatewayEdgeLocalDataPlaneEnabled
	}
	...
	settings := &service.SystemSettings{
		NonOpenAIPool: func() service.NonOpenAIPoolSettings {
			if req.NonOpenAIPool != nil {
				return *req.NonOpenAIPool
			}
			return previousSettings.NonOpenAIPool
		}(),
		...
		CompactHomeEnabled:                                    resolveBool(req.CompactHomeEnabled, previousSettings.CompactHomeEnabled),
		...
		OpenAIPoolDownstreamModelLimitProtectionEnabled: func() bool {
			...
			return previousSettings.OpenAIPoolDownstreamModelLimitProtectionEnabled
		}(),
	...
	payload := dto.SystemSettings{
		NonOpenAIPool:                                         updatedSettings.NonOpenAIPool,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.GatewayOpenAIResponseHeaderTimeoutEnabled != after.GatewayOpenAIResponseHeaderTimeoutEnabled {
		changed = append(changed, "gateway_openai_response_header_timeout_enabled")
	}
