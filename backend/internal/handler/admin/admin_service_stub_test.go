...
func (s *stubAdminService) ListAccounts(ctx context.Context, page, pageSize int, platform, accountType, status, search string, groupID int64, privacyMode, poolMode string, sortBy, sortOrder string) ([]service.Account, int64, error) {
	...
	s.lastListAccounts.poolMode = poolMode
