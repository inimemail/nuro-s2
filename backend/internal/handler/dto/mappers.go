...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	for key, value := range a.Extra {
		if key != service.OllamaCloudUsageSessionExtraKey && key != service.OpenCodeGoUsageScopeKey && key != service.OpenCodeGoUsageIdentityKey && key != service.OpenCodeGoUsageSnapshotKey {
			cleanExtra[key] = value
		}
	}
	if snapshot := service.OpenCodeGoUsageSnapshotForAccount(a); snapshot != nil {
		cleanExtra[service.OpenCodeGoUsageSnapshotKey] = snapshot
	}
	out := &Account{
		ID:                                     a.ID,
		Name:                                   a.Name,
		...
		UpstreamBillingGuardEnabled:            a.UpstreamBillingGuardEnabled,
		UpstreamBillingGuardMaxMultiplier:      a.UpstreamBillingGuardMaxMultiplier,
		UpstreamBillingGuardBlocked:            a.UpstreamBillingGuardBlocked,
		UpstreamBillingGuardObservedMultiplier: a.UpstreamBillingGuardObservedMultiplier,
		UpstreamBillingGuardEvaluatedAt:        a.UpstreamBillingGuardEvaluatedAt,
		RateLimitedAt:                          a.RateLimitedAt,
		RateLimitResetAt:                       a.RateLimitResetAt,
		OverloadUntil:                          a.OverloadUntil,
		TempUnschedulableUntil:                 a.TempUnschedulableUntil,
		TempUnschedulableReason:                a.TempUnschedulableReason,
		OpenAIPoolSoftCooldownUntil:            a.OpenAIPoolSoftCooldownUntil,
		OpenAIPoolSoftCooldownDue:              a.OpenAIPoolSoftCooldownDue,
		OpenAIPoolSoftCooldownStatusCode:       a.OpenAIPoolSoftCooldownStatusCode,
		OpenAIPoolSoftCooldownReason:           a.OpenAIPoolSoftCooldownReason,
		OpenAIPoolSoftCooldownProbeModel:       a.OpenAIPoolSoftCooldownProbeModel,
		OpenAIPoolSoftCooldownProbeKind:        a.OpenAIPoolSoftCooldownProbeKind,
		OpenAIPoolSoftCooldownSource:           a.OpenAIPoolSoftCooldownSource,
		OpenAIPoolLastProbeStatusCode:          a.OpenAIPoolLastProbeStatusCode,
		OpenAIPoolLastProbeReason:              a.OpenAIPoolLastProbeReason,
		OpenAIPoolRecoveryProbeInFlight:        a.OpenAIPoolRecoveryProbeInFlight,
		AnthropicPoolSoftCooldownUntil:         a.AnthropicPoolSoftCooldownUntil,
		AnthropicPoolSoftCooldownDue:           a.AnthropicPoolSoftCooldownDue,
		AnthropicPoolSoftCooldownStatusCode:    a.AnthropicPoolSoftCooldownStatusCode,
		AnthropicPoolSoftCooldownReason:        a.AnthropicPoolSoftCooldownReason,
		AnthropicPoolSoftCooldownProbeModel:    a.AnthropicPoolSoftCooldownProbeModel,
		AnthropicPoolSoftCooldownProbeKind:     a.AnthropicPoolSoftCooldownProbeKind,
		AnthropicPoolSoftCooldownSource:        a.AnthropicPoolSoftCooldownSource,
		AnthropicPoolLastProbeStatusCode:       a.AnthropicPoolLastProbeStatusCode,
		AnthropicPoolLastProbeReason:           a.AnthropicPoolLastProbeReason,
		AnthropicPoolRecoveryProbeInFlight:     a.AnthropicPoolRecoveryProbeInFlight,
		NonOpenAIPoolSoftCooldownUntil:         a.NonOpenAIPoolSoftCooldownUntil,
		NonOpenAIPoolSoftCooldownDue:           a.NonOpenAIPoolSoftCooldownDue,
		NonOpenAIPoolSoftCooldownStatusCode:    a.NonOpenAIPoolSoftCooldownStatusCode,
		NonOpenAIPoolSoftCooldownReason:        a.NonOpenAIPoolSoftCooldownReason,
		NonOpenAIPoolSoftCooldownProbeModel:    a.NonOpenAIPoolSoftCooldownProbeModel,
		NonOpenAIPoolSoftCooldownProbeKind:     a.NonOpenAIPoolSoftCooldownProbeKind,
		NonOpenAIPoolSoftCooldownSource:        a.NonOpenAIPoolSoftCooldownSource,
		NonOpenAIPoolLastProbeStatusCode:       a.NonOpenAIPoolLastProbeStatusCode,
		NonOpenAIPoolLastProbeReason:           a.NonOpenAIPoolLastProbeReason,
		NonOpenAIPoolRecoveryProbeInFlight:     a.NonOpenAIPoolRecoveryProbeInFlight,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		SlotWaitMs:                l.SlotWaitMs,
		UpstreamHeaderMs:          l.UpstreamHeaderMs,
		UpstreamFirstByteMs:       l.UpstreamFirstByteMs,
		FirstClientFlushMs:        l.FirstClientFlushMs,
		EdgePrepareMs:             l.EdgePrepareMs,
		EdgeQueueWaitMs:           l.EdgeQueueWaitMs,
		EdgeRelayStartMs:          l.EdgeRelayStartMs,
		EdgeFallbackReason:        l.EdgeFallbackReason,
		EdgeRetryCount:            l.EdgeRetryCount,
