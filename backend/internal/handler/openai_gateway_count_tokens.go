...
// GrokCountTokens handles Anthropic-compatible count_tokens locally. Route
// middleware already authenticated the API key and resolved its group. This
// deliberately skips billing, account selection, credentials, and concurrency.
