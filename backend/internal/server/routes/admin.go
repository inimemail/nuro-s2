...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUp middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.PUT("/:id/ollama-cloud-usage/session", h.Admin.Account.SetOllamaCloudUsageSession)
		accounts.DELETE("/:id/ollama-cloud-usage/session", h.Admin.Account.DeleteOllamaCloudUsageSession)
		accounts.PATCH("/:id/ollama-cloud-usage/auto-refresh", h.Admin.Account.SetOllamaCloudUsageAutoRefresh)
		...
		accounts.POST("/:id/codex/reset-credit", h.Admin.Account.ConsumeCodexResetCredit)
		accounts.GET("/:id/codex/reset-credit-usage", h.Admin.Account.QueryCodexResetCreditUsage)
		accounts.PUT("/:id/codex/auto-reset-mode", h.Admin.Account.UpdateCodexAutoResetMode)
		...
		accounts.PUT("/:id/upstream-billing-guard", h.Admin.Account.UpdateUpstreamBillingGuard)

		// Antigravity 默认模型映射
		accounts.GET("/antigravity/default-model-mapping", h.Admin.Account.GetAntigravityDefaultModelMapping)

		// Spark shadow account
...
func registerOpenAIOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	openai := admin.Group("/openai")
	{
		...
		openai.POST("/device-auth/exchange", h.Admin.OpenAIOAuth.ExchangeDeviceAuth)
...
func registerGrokOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	grok := admin.Group("/grok")
	{
		...
		grok.POST("/oauth/create-account", h.Admin.GrokOAuth.CreateAccountFromOAuth)
