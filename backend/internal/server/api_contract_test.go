				...
				"data": {
					"items": [
						...
						"billing_type": 0,
							...
							"edge_prepare_ms": null,
							"edge_queue_wait_ms": null,
							"edge_relay_start_ms": null,
							"edge_fallback_reason": null,
							"edge_retry_count": null,
							"image_count": 0,
		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"openai_pool_recovery_probe_model": "gpt-5.4",
...
func (r *stubUserRepo) AdjustBalance(_ context.Context, id int64, delta float64) (service.BalanceChange, error) {
	user, ok := r.users[id]
	if !ok {
...
func (r *stubUserRepo) SetBalance(_ context.Context, id int64, value float64) (service.BalanceChange, error) {
	user, ok := r.users[id]
	if !ok {
		return service.BalanceChange{}, service.ErrUserNotFound
	}
...
func (s *stubAccountRepo) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, privacyMode, poolMode string) ([]service.Account, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
