...
func Logger() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if rejected {
			fields = append(fields, zap.String("ingress_reject_reason", string(reason)), zap.Bool(logger.OpsSystemLogSkipField, true))
		}
