...
func (s *stubUserRepo) AdjustBalance(context.Context, int64, float64) (service.BalanceChange, error) {
	panic("unexpected AdjustBalance call")
}

func (s *stubUserRepo) SetBalance(context.Context, int64, float64) (service.BalanceChange, error) {
