...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, apiKeyAuth, auditLog, stepUp, apiKeyService, subscriptionService, opsService, settingService, cfg, redisClient)
}
