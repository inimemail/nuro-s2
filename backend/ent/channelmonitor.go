...
type ChannelMonitor struct {
	...
	// CheckMode holds the value of the "check_mode" field.
...
func (*ChannelMonitor) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case channelmonitor.FieldID, channelmonitor.FieldAccountID, channelmonitor.FieldIntervalSeconds, channelmonitor.FieldCreatedBy, channelmonitor.FieldTemplateID:
