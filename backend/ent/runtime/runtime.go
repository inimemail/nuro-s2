...
func init() {
	...
	groupDescStrictModelPriorityOnModelMismatch := groupFields[56].Descriptor()
	...
	groupDescAccountSchedulingStrategy := groupFields[57].Descriptor()
	...
	usagelogDescRequestedReasoningEffort := usagelogFields[9].Descriptor()
	...
	usagelogDescNativeCompactionV2 := usagelogFields[10].Descriptor()
	...
	usagelogDescModelMappingChain := usagelogFields[13].Descriptor()
	...
	usagelogDescBillingTier := usagelogFields[14].Descriptor()
	...
	usagelogDescBillingMode := usagelogFields[15].Descriptor()
