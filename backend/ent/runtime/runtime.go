...
func init() {
	...
	groupDescAllowLive := groupFields[19].Descriptor()
	...
	groupDescStrictModelPriorityOnModelMismatch := groupFields[55].Descriptor()
	...
	groupDescForceOpenaiFast := groupFields[57].Descriptor()
