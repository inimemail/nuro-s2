...
func init() {
	...
	// accountDescUpstreamBillingGuardEnabled is the schema descriptor for upstream_billing_guard_enabled field.
	accountDescUpstreamBillingGuardEnabled := accountFields[18].Descriptor()
	// account.DefaultUpstreamBillingGuardEnabled holds the default value on creation for the upstream_billing_guard_enabled field.
	account.DefaultUpstreamBillingGuardEnabled = accountDescUpstreamBillingGuardEnabled.Default.(bool)
	// accountDescUpstreamBillingGuardMaxMultiplier is the schema descriptor for upstream_billing_guard_max_multiplier field.
	accountDescUpstreamBillingGuardMaxMultiplier := accountFields[19].Descriptor()
	// account.DefaultUpstreamBillingGuardMaxMultiplier holds the default value on creation for the upstream_billing_guard_max_multiplier field.
	account.DefaultUpstreamBillingGuardMaxMultiplier = accountDescUpstreamBillingGuardMaxMultiplier.Default.(float64)
	// accountDescUpstreamBillingGuardBlocked is the schema descriptor for upstream_billing_guard_blocked field.
	accountDescUpstreamBillingGuardBlocked := accountFields[20].Descriptor()
	// account.DefaultUpstreamBillingGuardBlocked holds the default value on creation for the upstream_billing_guard_blocked field.
	account.DefaultUpstreamBillingGuardBlocked = accountDescUpstreamBillingGuardBlocked.Default.(bool)
	...
	accountgroupDescCreatedAt := accountgroupFields[5].Descriptor()
	...
	// batchimagejobDescSessionID is the schema descriptor for session_id field.
	batchimagejobDescSessionID := batchimagejobFields[1].Descriptor()
	// batchimagejob.SessionIDValidator is a validator for the "session_id" field. It is called by the builders before save.
	batchimagejob.SessionIDValidator = batchimagejobDescSessionID.Validators[0].(func(string) error)
	...
	batchimagejobDescParentBatchID := batchimagejobFields[8].Descriptor()
	...
	batchimagejobDescStatus := batchimagejobFields[9].Descriptor()
	...
	batchimagejobDescProviderJobName := batchimagejobFields[10].Descriptor()
	...
	batchimagejobDescProviderInputRef := batchimagejobFields[11].Descriptor()
	...
	batchimagejobDescProviderOutputRef := batchimagejobFields[12].Descriptor()
	...
	batchimagejobDescGcsInputURI := batchimagejobFields[13].Descriptor()
	...
	batchimagejobDescGcsOutputURI := batchimagejobFields[14].Descriptor()
	...
	batchimagejobDescSuccessCount := batchimagejobFields[16].Descriptor()
	...
	batchimagejobDescFailCount := batchimagejobFields[17].Descriptor()
	...
	batchimagejobDescCancelledCount := batchimagejobFields[18].Descriptor()
	...
	batchimagejobDescBaseUnitPrice := batchimagejobFields[22].Descriptor()
	...
	batchimagejobDescGroupRateMultiplier := batchimagejobFields[23].Descriptor()
	...
	batchimagejobDescAccountRateMultiplier := batchimagejobFields[24].Descriptor()
	...
	batchimagejobDescBatchDiscountMultiplier := batchimagejobFields[25].Descriptor()
	...
	batchimagejobDescHoldMultiplier := batchimagejobFields[26].Descriptor()
	...
	batchimagejobDescBillableUnitPrice := batchimagejobFields[27].Descriptor()
	...
	batchimagejobDescHoldUnitPrice := batchimagejobFields[28].Descriptor()
	...
	batchimagejobDescPricingSnapshotVersion := batchimagejobFields[29].Descriptor()
	...
	groupDescAllowLive := groupFields[20].Descriptor()
	...
	groupDescStrictModelPriorityOnModelMismatch := groupFields[57].Descriptor()
	...
	// groupDescAccountSchedulingStrategy is the schema descriptor for account_scheduling_strategy field.
	groupDescAccountSchedulingStrategy := groupFields[58].Descriptor()
	// group.DefaultAccountSchedulingStrategy holds the default value on creation for the account_scheduling_strategy field.
	group.DefaultAccountSchedulingStrategy = groupDescAccountSchedulingStrategy.Default.(string)
	// group.AccountSchedulingStrategyValidator is a validator for the "account_scheduling_strategy" field. It is called by the builders before save.
	group.AccountSchedulingStrategyValidator = groupDescAccountSchedulingStrategy.Validators[0].(func(string) error)
	// groupDescAdaptiveTtftSwitchEnabled is the schema descriptor for adaptive_ttft_switch_enabled field.
	groupDescAdaptiveTtftSwitchEnabled := groupFields[59].Descriptor()
	// group.DefaultAdaptiveTtftSwitchEnabled holds the default value on creation for the adaptive_ttft_switch_enabled field.
	group.DefaultAdaptiveTtftSwitchEnabled = groupDescAdaptiveTtftSwitchEnabled.Default.(bool)
	// groupDescAdaptiveTtftSwitchThresholdSeconds is the schema descriptor for adaptive_ttft_switch_threshold_seconds field.
	groupDescAdaptiveTtftSwitchThresholdSeconds := groupFields[60].Descriptor()
	// group.DefaultAdaptiveTtftSwitchThresholdSeconds holds the default value on creation for the adaptive_ttft_switch_threshold_seconds field.
	...
	usagelogDescSessionID := usagelogFields[5].Descriptor()
	...
	// usagelogDescRequestedReasoningEffort is the schema descriptor for requested_reasoning_effort field.
	usagelogDescRequestedReasoningEffort := usagelogFields[10].Descriptor()
	// usagelog.RequestedReasoningEffortValidator is a validator for the "requested_reasoning_effort" field. It is called by the builders before save.
	usagelog.RequestedReasoningEffortValidator = usagelogDescRequestedReasoningEffort.Validators[0].(func(string) error)
	// usagelogDescNativeCompactionV2 is the schema descriptor for native_compaction_v2 field.
	usagelogDescNativeCompactionV2 := usagelogFields[11].Descriptor()
	// usagelog.DefaultNativeCompactionV2 holds the default value on creation for the native_compaction_v2 field.
	usagelog.DefaultNativeCompactionV2 = usagelogDescNativeCompactionV2.Default.(bool)
	...
	userDescRestrictPublicGroups := userFields[11].Descriptor()
