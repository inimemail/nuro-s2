...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "upstream_billing_guard_enabled", Type: field.TypeBool, Default: false},
		{Name: "upstream_billing_guard_max_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "double precision"}},
		{Name: "upstream_billing_guard_blocked", Type: field.TypeBool, Default: false},
		{Name: "upstream_billing_guard_observed_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "double precision"}},
		{Name: "upstream_billing_guard_evaluated_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	AccountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "idx_accounts_upstream_billing_guard_blocked",
				Unique:  false,
	...
	AccountGroupsColumns = []*schema.Column{
		{Name: "priority", Type: field.TypeInt, Default: 50},
		{Name: "upstream_billing_guard_max_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "double precision"}},
		{Name: "upstream_billing_guard_min_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "double precision"}},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	AccountGroupsTable = &schema.Table{
		...
		PrimaryKey: []*schema.Column{AccountGroupsColumns[4], AccountGroupsColumns[5]},
		ForeignKeys: []*schema.ForeignKey{
			{
	...
	BatchImageJobsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BatchImageJobsColumns[6], BatchImageJobsColumns[10]},
			},
			{
				Name:    "batchimagejob_task_name",
				Unique:  false,
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorsColumns[13], ChannelMonitorsColumns[15]},
			},
			{
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "edge_protection_enabled", Type: field.TypeBool, Nullable: true},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "requested_reasoning_effort", Type: field.TypeString, Nullable: true, Size: 20},
		{Name: "native_compaction_v2", Type: field.TypeBool, Default: false},
		...
		{Name: "slot_wait_ms", Type: field.TypeInt, Nullable: true},
		{Name: "upstream_header_ms", Type: field.TypeInt, Nullable: true},
		{Name: "upstream_first_byte_ms", Type: field.TypeInt, Nullable: true},
		{Name: "first_client_flush_ms", Type: field.TypeInt, Nullable: true},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_upstream_response_model",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[6]},
			},
			{
				Name:    "usagelog_upstream_model_mismatch",
				Unique:  false,
